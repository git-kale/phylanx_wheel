patchelf --set-rpath '$ORIGIN/../phylanx-libs:$ORIGIN/../phylanx-libs/boost:$ORIGIN/../phylanx-libs/extras' /github/home/phylanx-0.0.1/phylanx/_phylanxd.cpython-37m-x86_64-linux-gnu.so
